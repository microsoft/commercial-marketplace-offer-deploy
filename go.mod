module github.com/microsoft/commercial-marketplace-offer-deploy
...
require (
	...
	github.com/microsoft/commercial-marketplace-offer-deploy/sdk v0.0.0-20230328210100-4067f428c401
...
require (
	...
	github.com/elsevierlabs-os/go-envs v0.4.0 // indirect
