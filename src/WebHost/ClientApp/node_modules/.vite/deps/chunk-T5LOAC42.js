...
setVersion("@fluentui/react", "8.111.2");
  ...
  function() {
    ...
    Stylesheet2.getInstance = function() {
      ...
      if (!_stylesheet || _stylesheet._lastStyleElement && _stylesheet._lastStyleElement.ownerDocument !== document) {
        ...
        _global[STYLESHEET_SETTING] = stylesheet2;
      }
      return _stylesheet;
    };
...
function fontFace(font) {
  ...
  stylesheet2.insertRule("@font-face{".concat(rule, "}"), true);
...
var WindowContext = React13.createContext({
  window: typeof window === "object" ? window : void 0
});
var useWindow = function() {
  return React13.useContext(WindowContext).window;
};
var useDocument = function() {
  var _a3;
  return (_a3 = React13.useContext(WindowContext).window) === null || _a3 === void 0 ? void 0 : _a3.document;
};
var WindowProvider = function(props) {
  return React13.createElement(WindowContext.Provider, { value: props }, props.children);
};

// node_modules/@fluentui/react-hooks/lib/useAsync.js
var React14 = __toESM(require_react());
function useAsync() {
  var asyncRef = React14.useRef();
  if (!asyncRef.current) {
  ...
  React14.useEffect(function() {
    return function() {
      var _a3;
      (_a3 = asyncRef.current) === null || _a3 === void 0 ? void 0 : _a3.dispose();
...
function useBoolean(initialState) {
  var _a3 = React16.useState(initialState), value = _a3[0], setValue = _a3[1];
...
function useControllableValue(controlledValue, defaultUncontrolledValue, onChange) {
  var _a3 = React17.useState(defaultUncontrolledValue), value = _a3[0], setValue = _a3[1];
...
function useId(prefix, providedId) {
  var ref = React19.useRef(providedId);
  if (!ref.current) {
...
function useMergedRefs() {
  ...
  var mergedCallback = React20.useCallback(function(value) {
...
function useOnEvent(element, eventName, callback, useCapture) {
  var callbackRef = React21.useRef(callback);
...
function useTarget(target, hostElement) {
  var previousTargetProp = React23.useRef();
  var targetRef = React23.useRef(null);
...
var useUnmount = function(callback) {
  var unmountRef = React24.useRef(callback);
  unmountRef.current = callback;
  React24.useEffect(function() {
    return function() {
      var _a3;
      (_a3 = unmountRef.current) === null || _a3 === void 0 ? void 0 : _a3.call(unmountRef);
    };
  }, []);
};
...
function useWarnings(options) {
  if (true) {
    ...
    var hasWarnedRef = React25.useRef(false);
...
//# sourceMappingURL=chunk-T5LOAC42.js.map
