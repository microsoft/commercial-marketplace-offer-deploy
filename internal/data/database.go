...
func createInstance(dsn string, models ...interface{}) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&model.Deployment{}, &model.Stage{}, &model.EventHook{}, &model.EventHookMessage{}, &model.InvokedOperation{}, &model.InvokedOperationAttribute{}); err != nil {
