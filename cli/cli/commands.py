...
def build_application_package(name, description, version, vmi_reference, vmi_reference_id, main_template, create_ui_definition, current_working_dir, out_dir = None):
