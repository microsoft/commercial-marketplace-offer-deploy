...
@click.option("--resources-file", default=None, help="The reference to resources file to use when package. This must be used in combination with a direct vmi-reference-id being set.")
...
def build_application_package(name, description, version, vmi_reference, vmi_reference_id, resources_file, main_template, create_ui_definition, current_working_dir, out_dir = None):
    ...
    options = CreateApplicationPackageOptions(version, vmi_reference, vmi_reference_id, resources_file)
