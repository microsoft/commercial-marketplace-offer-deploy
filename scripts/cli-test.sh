...
function test_package_build() {
    ...
    modm package build \
        ...
        --vmi-reference-id /subscriptions/31e9f9a0-9fd2-4294-a0a3-0101246d9700/resourceGroups/modm-dev-vmi/providers/Microsoft.Compute/galleries/modm.dev.sig/images/modm/versions/2.0.221 \
    ...
    echo "Build terraform gold app"
    echo "modm package build with a direct resources file path being used instead of what's in release"
    echo ""
    modm package build \
        --name "Gold terraform app" \
        --description "Simple Terraform application template that deploys a storage account" \
        --resources-file ./dist/resources.tar.gz \
        --vmi-reference-id /subscriptions/31e9f9a0-9fd2-4294-a0a3-0101246d9700/resourceGroups/modm-dev-vmi/providers/Microsoft.Compute/galleries/modm.dev.sig/images/modm/versions/2.0.221 \
        --main-template build/managedapp/terraform/gold/templates/main.tf \
        --create-ui-definition build/managedapp/terraform/gold/createUiDefinition.json \
        --out-dir ./dist
}
